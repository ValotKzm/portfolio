...
export const DisplayProjects = () => {
    ...
    if (loading) {
        return (
            <div id="projects" className="h-screen bg-gray-900 text-white flex flex-col items-center justify-center pb-20 md:pb-32">
    ...
    return (
        <div id="projects" className="min-h-screen bg-gray-900 text-white flex flex-col items-center justify-center py-8 md:py-0 pb-20 md:pb-32">
